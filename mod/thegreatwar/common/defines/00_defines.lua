...
NGame = {
	...
	TRADE_ROUTE_RECALCULATE_FREQUENCY_DAYS = 48, -- #HOI4TGW ::: Max recalculation time for all trade routes (0 means we do not recalucate prediodically trade routes)
...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "1910.1.1.12",	-- #HOI4TGW ::: Starting at this date, the tension values will be scaled down (will be equal to 1 before that) 	#HOI4TGW ::: TENSION_TIME_SCALE_START_DATE = "1936.1.1.12",
